...
#graph #2
plot(days$Voltage ~ days$Time, type="l", ylab="Voltage", xlab="datetime")
# graph #3
...
#graph #4
plot(days$Global_reactive_power ~ days$Time, type="l", ylab="Global_reactive_power", xlab="datetime")
